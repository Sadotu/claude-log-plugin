---
name: "log:bug"
description: "Log a bug to the current repository's backlog"
---

Log a bug to the current repository's backlog.

## Arguments
The full text after the command is the bug description: `$ARGUMENTS`
...
ENTRY="- [ ] #${ID} [bug] ${DATE} · branch:${BRANCH} — ${DESCRIPTION}"
```
...
Then append the entry on a new line under `## Open`, before `## Done`. The file should look like:
```
# Backlog — myrepo

## Open
- [ ] #1 [bug] 2026-03-10 · branch:main — description here
...
Tell the user: "Logged #<ID> [bug]: <DESCRIPTION>"
